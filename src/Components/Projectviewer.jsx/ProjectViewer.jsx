...
import Brochure1 from "../../assets/Images/flowimg4.png";
...
const MapComponent = () => {
  ...
  const websiteOverlays = [
    { src: Project01, label: 'Website 1' },
    { src: Project02, label: 'Website 2' },
  ];
    ...
    <div className="container flex flex-col">
      ...
      <div className='flex items-center gap-3'>
        ...
        <div className="relative z-10 mb-4 mt-2">
          <select
            className={`block appearance-none font-bold w-full border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none 
