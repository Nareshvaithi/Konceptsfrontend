...
{employeeCard.map((value,index) => {
        return (
          <>
                  <SwiperSlide className="w-full h-full flex justify-center items-center px-10 border-1 " key={index}>
            <div className="aboutExpCardContainer border-collapse border-gray-200">
              <div className="flex items-start justify-between">
                <div>
                  <div className="border-4 py-10 mt-20">
